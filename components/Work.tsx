  ...
  return (
    <main className="bg-gradient-to-b from-blue-900 via-blue-800 to-blue-700 py-12 px-4">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          <button className="group inline-flex items-center gap-2 bg-cyan-400 text-blue-900 font-bold text-lg px-8 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all">
